...
#           Multiple Linear Regression: ANOVA Testing          #
#                          ANOVA Testing                       #
################################################################
...
# ANOVA for MLR (reg2: tests for each term are conditioned for everything else above it.
...
# F=((270.56-257.57)/2)/(257.57/108) # In R RSS is the SSE.
