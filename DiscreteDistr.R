...
dbinom(5, 20, 0.06) # x=5, n=20 prob = 0.06
...
# Calculate prob of receiving mostly 8 calls in one hour: P(X<=8)
# ppois() gives the cumulative probabilities

ppois(8,10)


# Observe the shape of different Poisson distributions with varying lambdas
par(mfrow = c(1, 3)) 
